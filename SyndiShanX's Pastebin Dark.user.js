// ==UserScript==
// @name           SyndiShanX's Pastebin Dark
// @author         SyndiShanX
...
/**
 * @name Pastebin Dark
 * @description A Custom Dark Theme for Pastebin, meant to be used with Pastebin Dark Mode
 * @author SyndiShanX#4620
 * @version 1.15
*/

:root {
	--theme: Pastebin Dark by SyndiShanX;
...
.wrap, tr:hover, .top-footer, .footer, .footer__container, body, .notice, input, textarea, .select2-selection, .dropdown-menu a, #usernotificationsform-email_notifications_status,
...
input, textarea, .select2-selection, .highlighted-code, #usernotificationsform-email_notifications_status {
...
.container:not(.header .container), .de1 {
	background-color: rgba(0, 0, 0, 0.25)!important;
}
.night-auto .highlighted-code .source>ol, .night .highlighted-code .source>ol, .top-buttons {
  background: rgba(0, 0, 0, 0.005)!important;
}
.de1, .li1, .dropdown-menu a:hover, .select2-results__option:hover {
...
/* Buttons */
/* Gray */
.sign-in, .btn, .cd-top, .custom-file-input::before {
	background-color: var(--gray-button)!important;
	border-color: var(--gray-button-border)!important;
	color: #fff!important;
}
.sign-in:hover, .btn:hover, .cd-top:hover, .custom-file-input::before:hover {
