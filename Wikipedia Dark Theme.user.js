...
/*
 * @name Wikipedia Dark
 * @description A Custom Dark Theme for Wikipedia
 * @author SyndiShanX#4620
 * @version 1.15
*/

:root {
	--theme: Wikipedia Dark by SyndiShanX;
...
.mw-page-container, .vector-toc, .vevent>th, .vector-search-box-input {
...
.description, .wikitable>tbody>tr>td {
...
.wikitable>tbody>tr>th, .vector-header-container {
...
/* Main Tweaks */
.mw-first-heading, .noprint, p, span, .vector-toc-text, li, .description, .summary, td, th {
  color: #fff;
}
