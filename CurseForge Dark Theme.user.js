...
body, .project-page, .breadcrumbs, code, .member-card, .file-card, .search-input-field {
...
.file-details-card, .project-details-box, .comment {
...
code, .member-card, .file-card, .search-input-field, .comment, .info-warning {
  border-radius: 8px;
}
code, .search-input-field, .comment, .member-card, .file-card {
	border: 1px solid var(--border-primary)!important;
}
code:hover, .search-input-field:hover, .comment:hover, .member-card:hover, .file-card:hover {
...
/* Gray */
.btn-cta.download-cta, .btn-login, .link-btn, .btn-secondary {
	background-color: var(--gray-button)!important;
	border-color: var(--gray-button-border)!important;
	color: #fff!important;
}
.btn-cta.download-cta:hover, .btn-login:hover, .link-btn:hover, .btn-secondary:hover {
